...
public class DragLinearLayout extends LinearLayout {
    ...
    public void removeDragView(View child) {
        removeDragView(child, null, false);
    }

    public void removeDragView(View child, @Nullable View handle, boolean onlyRemoveHandle) {
        if (this == child.getParent()) {
            final int index = indexOfChild(child);
            if (!onlyRemoveHandle) removeView(child);
